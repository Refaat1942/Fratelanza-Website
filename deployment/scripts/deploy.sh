...
echo ""
echo "Next steps (connect www.fratelanza.com):"
echo "  1. Add DNS A record: www -> your VPS IP"
echo "  2. Run: ./deployment/scripts/setup-domain.sh"
echo "  See docs/DOMAIN_SETUP.md for full guide"
